...
class LedgerEditor extends Component {
  ...
  componentDidMount() {
    ...
    if (ledger) {
      const nledger = { ...ledger, date: new moment().format() };
      this.setState({ nledger });
    }
  }
  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: '#e8e8e8', padding: 8, overflow: 'auto' }}>
        <Button
          onClick={handleClose}
            ...
            <Row style={{ marginBottom: 8 }}>
              <Col span={12}>
                <Input
                  value={debit}
                  onChange={e => {
                    this.handleChanges('amount', -parseInt(e.target.value));
                  }}
                  placeholder="Debit"
                />
              </Col>
            ...
            <Row>
              ...
              <Col span={8}>
                <Row>
                  ...
                  <Button style={{ float: 'right' }} onClick={this.handleSave} type="primary">
                    Save
                  </Button>
                </Row>
              </Col>
